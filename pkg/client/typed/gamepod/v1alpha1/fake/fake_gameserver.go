...
type FakeGameServers struct {
	Fake *FakeGamepodV1alpha1
	ns   string
}

var gameserversResource = schema.GroupVersionResource{Group: "gamepod.cc", Version: "v1alpha1", Resource: "gameservers"}

var gameserversKind = schema.GroupVersionKind{Group: "gamepod.cc", Version: "v1alpha1", Kind: "GameServer"}
